...
cd /tmp/ && yum install git -y && git clone https://github.com/PeymanNaeimi/Personal-vpn.git && cd Personal-vpn/ && sed -i -e 's/\r$//' centos7.sh && chmod 755 centos7.sh && ./centos7.sh 
